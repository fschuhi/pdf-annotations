...
- User says "this feels overly complicated" → STOP. Reassess fundamentally.
- User says "why are we doing this?" → STOP. You missed something crucial.
...
6. **Question complexity.** Simple beats clever. Ask "why" before adding structure.
