...
This is some additional text added manually, with an empty line after the frontmatter separator.
...
> So, in this definition, destructive emotions are "those that cause harm to ourselves or to others" ([1], p. 12). <span class="pdf-annot-date">21.10.25 21:20</span> [1](pdf://VQGPEHE?page=1)
