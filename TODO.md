...
- ~~**`pdf_ctime`:** One-time batch tool backfilled ~200 existing bibnotes from `pdf_mtime`; `sync.py`/`frontmatter.py` now seed it on every new bibnote and leave it untouched afterward.~~ Landed 2026-07-25; see `HISTORY.md`.
